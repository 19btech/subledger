...
class AccountTypesItemProcessorTest {
    ...
    private AccountTypesItemProcessor processor;

    @BeforeEach
    void setUp() {
        validator = new AccountTypesValidator();
        processor = new AccountTypesItemProcessor(validator, accountTypesRepository, validationLogRepository);

        JobExecution jobExecution = new JobExecution(201L);
        StepExecution stepExecution = new StepExecution("accountTypesImportStep", jobExecution);
    ...
    void testDuplicateAlreadyInDbIsCaughtOnReUpload() throws Exception {
        ...
        org.springframework.batch.core.JobParameters jobParams = new JobParametersBuilder()
                ...
                .toJobParameters();
        JobExecution jobExecution = new JobExecution(202L, jobParams);
        StepExecution stepExecution = new StepExecution("accountTypesImportStep", jobExecution);
        processor.beforeStep(stepExecution);
