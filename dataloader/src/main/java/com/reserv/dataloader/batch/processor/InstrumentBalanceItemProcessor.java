...
public class InstrumentBalanceItemProcessor implements ItemProcessor<Map<String, Object>, InstrumentLevelLtd> {

    @Override
    public InstrumentLevelLtd process(Map<String, Object> item) throws Exception {
        ...
        return InstrumentLevelLtd.builder()
