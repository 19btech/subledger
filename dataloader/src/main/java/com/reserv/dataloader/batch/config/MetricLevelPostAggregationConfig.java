...
public class MetricLevelPostAggregationConfig {
    ...
    @Bean
    @StepScope
    public StreamingAggregationItemReader<MetricLevelLtd> metricLevelPostAggregationReader(
        ...
        return new StreamingAggregationItemReader<>(
                dataService::getMongoTemplate, aggregation, "MetricLevelLtd", MetricLevelLtd.class, chunkSize);
    }
