...
public class PulsarSchemaConfig {
    ...
    public PulsarSchemaConfig(@Value("${spring.pulsar.client.service-url}") String pulsarHttpUrl,
                              @Value("${spring.pulsar.producer.topic-bookGLStaging}") String topic)
    ...
    public void configureSchemaCompatibility() {
        try {
            ...
            pulsarAdmin.schemas().createSchema(topicFQN, (SchemaInfo) Schema.AVRO(Records.GeneralLedgerMessageRecord.class));
