...
import com.fyntrac.reporting.service.CustomRefDataReportingService;
...
@RestController
@RequestMapping("/api/reporting/custom-ref-data")
@Slf4j
public class CustomRefDataReportController {
    private final CustomRefDataReportingService reportingService;
    public CustomRefDataReportController(CustomRefDataReportingService reportingService) {
