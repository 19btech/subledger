...
@Slf4j
@Service
public class CustomRefDataReportingService {

    private final CustomTableDefinitionRepository customTableDefinitionRepository;
    private final DataService<?> dataService;
    public CustomRefDataReportingService(CustomTableDefinitionRepository customTableDefinitionRepository,
    ...
    public List<Option> getRefDataTables() {
        return customTableDefinitionRepository
                .findByTableType(CustomTableType.REFERENCE)
